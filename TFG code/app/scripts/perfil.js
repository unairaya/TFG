...
mostrarChangePassword.addEventListener('click', () => changePasswordContainer.style.display = 'flex')
cancelar.addEventListener('click', () => changePasswordContainer.style.display = 'none')
...
function cambiarContraseña(e) {
	...
	database.getUser('true', (user) => {
		if(oldPassword != user.password){
			mostrarNotificacion(3)
			return
		}
		database.changePassword(newPassword1, () => window.open('./perfil.html', '_self'))
